...
export class ClassesService {
    ...
    public specializations: Specialization[] = [
        ...
        new Specialization(66, "Paladin", "Paladin", "Protection", "Tank", true),
        new Specialization(70, "Paladin", "Paladin", "Retribution", "Melee", true),
        ...
        new Specialization(252, "DeathKnight", "Death Knight", "Unholy", "Melee", true),
        new Specialization(253, "Hunter", "Hunter", "Beast Mastery", "Ranged", true),
        new Specialization(254, "Hunter", "Hunter", "Marksmanship", "Ranged", true),
        ...
        new Specialization(259, "Rogue", "Rogue", "Assassination", "Melee", true),
        new Specialization(260, "Rogue", "Rogue", "Combat", "Melee", true),
        new Specialization(261, "Rogue", "Rogue", "Subtlety", "Melee", true),
        new Specialization(262, "Shaman", "Shaman", "Elemental", "Ranged", true),
        new Specialization(263, "Shaman", "Shaman", "Enhancement", "Melee", true),
        ...
        new Specialization(269, "Monk", "Monk", "Windwalker", "Melee", true),
