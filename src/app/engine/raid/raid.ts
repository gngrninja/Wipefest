...
import { Specialization } from "app/engine/specializations/specialization";

export module RaidFactory {

    export function Get(combatantInfos: CombatEvent[], friendlies: Actor[], specializationsService: SpecializationsService): Raid {
        ...
        let players = friendlies.map(x => {
            ...
            if (combatantInfo) {
                ...
                specialization = specializationsService.getSpecialization(combatantInfo.specID);
            }
