...
export module ArgusTheUnmakerInsightConfigs {
    ...
    export function All(): InsightConfig[] {
        return [
            ...
            new DebuffUnlessRole("0", 2092, ["Sweeping Scythe", "Deadly Scythe"], [248499, 258039], "Tank"),
            new Hit("1", 2092, ["Death Fog"], [248167]),
            new DebuffDuration("2", 2092, "Strength of the Sky", "Strength of the Sky (Removed)"),
            new DebuffDuration("3", 2092, "Strength of the Sea", "Strength of the Sea (Removed)"),
            ...
            new HitWithoutDebuff("6", 2092, ["Cosmic Ray"], [252707], ["Cosmic Ray"], [252729], 10000),
