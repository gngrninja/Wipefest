...
export module PortalKeeperHasabelInsightConfigs {
    ...
    export function All(): InsightConfig[] {
        return [
          ...
          new Hit(2064, ["Collapsing World > 3m"], [243984], `Stood in {abilities} {totalHits} time{plural}.`, null, `
...
and move her whenever she casts {ability:243984:Collapsing World:shadow}.`),
          new Hit(2064, ["Felstorm Barrage"], [244001], null, null, `
...
Lines spawn one after another at different angles, but always go through the center of the platform.`),
          new Interrupt(2064, ["Fiery Detonation"], [244709], null, null, `
...
{ability:244709:Fiery Detonation:fire} is not cast.`),
          new Interrupt(2064, ["Howling Shadows"], [245504], null, null, `
When {npc:Portal Keeper Hasabel} casts {ability:244689:Transport Portal:shadow},
...
then all players within 60 yards will be interrupted for 6 seconds.`),
            ...
            new Interrupt(2064, ["Flames of Xoroth"], [244607], null, null, `
...
which will deal damage to all nearby players unless interrupted.`),
            new Hit(2064, ["Supernova"], [244601], null, null, `
...
Impact locations are marked by swirls, and are easy to avoid.`),
            ...
            new DebuffDuration(2064, "Felsilk Wrap", "Felsilk Wrap (Removed)", 0, `
Took an average of {averageDuration} to free allies from {ability}.`, null, `
...
While players are trapped, they are taking damage, and should be freed as quickly as possible.`),
            ...
            new DebuffDuration(2064, "Delusions", "Delusions (Removed)", 0, `
Waited for an average of {averageDuration} before dispelling {ability}.`, null, `
...
so that they can heal again.`),
            new DebuffDuration(2064, "Mind Fog", "Mind Fog (Removed)", 0, `
Clouded by {ability} for an average of {averageDuration}.`, null, `
