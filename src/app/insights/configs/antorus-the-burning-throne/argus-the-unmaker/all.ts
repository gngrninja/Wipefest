...
export module ArgusTheUnmakerInsightConfigs {
  ...
  export function All(): InsightConfig[] {
    return [
      ...
      new DebuffUnlessRole(2092, ["Sweeping Scythe", "Deadly Scythe"], [248499, 258039], "Tank"),
      new Hit(2092, ["Death Fog"], [248167]),
      new DebuffDuration(2092, "Strength of the Sky", "Strength of the Sky (Removed)"),
      new DebuffDuration(2092, "Strength of the Sea", "Strength of the Sea (Removed)"),

      // Soulbomb 251570 target has Aggramar's Boon 255200 when Soulbomb Detonation 251571
      new Debuff(2092, ["Edge of Obliteration"], [251815]),
      ...
      new Debuff(2092, ["Ember of Rage"], [257299]),
      new Death(2092, [256396]),
      new Debuff(2092, ["Soul Detonation"], [256899])
    ];
  }
