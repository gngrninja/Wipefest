...
export module TheDefenseOfEonarInsightConfigs {
  ...
  export function All(): InsightConfig[] {
    return [
      new ParaxisTeams("0"),
      new HitWithoutDebuff("1", 2075, ["Rain of Fel"], [248329], ["Rain of Fel"], [248332], 6000, null, null, `
...
Targeted players should move away to avoid allies being hit by unnecessary damage.`),
      new Hit("2", 2075, ["Fel Wake"], [248795], `
...
Players stood in these {ability:248795:Fel Wakes:fire} will take damage, so they should be avoided.`),
      new HitUnlessRole("3", 2075, ["Fel Swipe"], [250703], "Tank", null, null, `
...
when it swipes.`),
      new Interrupt("4", 2075, ["Artillery Strike"], [246305], null, null, `
