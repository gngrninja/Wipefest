...
export class HitWithoutDebuff extends InsightConfig {
    ...
    getProperties(context: InsightContext): any {
        ...
        let debuffAbilities = this.getAbilitiesIfTheyExist(debuffEvents, this.debuffAbilityIds);
        ...
        return {
            ...
            debuffApplicationTimeRelativeToDamageTime: MarkupHelper.Info(Timestamp)
        }
    }
