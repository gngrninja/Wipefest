...
${MarkupHelper.Style("arcane", "Twilight Glaive")} occurs roughly every 20 seconds,
...
(which increases the damage taken from ${MarkupHelper.Style("spellshadow", "Astral Purge")}).
${MarkupHelper.Style("physical", "Astral Vulnerability")} expires after 2 seconds.
...
On Mythic, make sure to watch the raid's current ${MarkupHelper.Style("physical", "Astral Vulnerability")} stacks before crossing the line.
Crossing at low or zero stacks will reduce unnecessary raid damage.
When teams split into groups of 5 or less to deal with ${MarkupHelper.Style("physical", "Astral Vulnerability")},
they typically decide to drop ${MarkupHelper.Style("spellshadow", "Astral Purge")} debuffs inbetween these groups.`;
